...
<!-- SCREENSHOT: homepage with the two Hypothesis icons visible in the right margin (collapsed state) -->
...
<!-- SCREENSHOT: page with the Hypothesis sidebar open, showing the "Annotations / Page Notes" tabs and "Sign up / Log in" button -->
...
<!-- SCREENSHOT: text selected on the page with the Annotate / Highlight popup visible -->
...
<!-- SCREENSHOT: Page Notes tab selected in the sidebar with the new-note button highlighted -->
