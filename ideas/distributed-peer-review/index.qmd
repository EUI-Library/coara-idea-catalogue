...
**Mitigation:** Implement a double-blind review process where both reviewer and applicant identities are anonymised. Providing bias-awareness training as part of the review onboarding can also help with this. Alternatively, a separate process where the applicants are divided into two pools with separate budgets and each pool assesses applications from the other pool could ensure that applicants do not directly assess evaluations from competitors.
...
The **Humboldt Foundation** has been experimenting with a linked concept, namely Review Circle. In Review Circles, instead of two separate written reviews per application, a group of six to ten reviewers compare and discuss several applications on a protected digital platform. Specifically, instead of requesting peer reviews for proposals separately, the review can be done combinedly on a digital, interactive platform where researchers exchange their reviews/comments and get to discuss about the quality and innovativeness of proposals. This way, the reviewers can also directly compare the proposals with each other and rank them. See more details [here](https://www.humboldt-foundation.de/en/explore/figures-and-statistics/evaluation/evaluation-of-the-2022-peer-circle-experiment).
