...
* **Challenge - Perceived loss of objectivity:** Narrative CVs are sometimes criticised for reducing the objectivity of applications processes, especially when compared to numerical metrics.  
...
* **Challenge: Internal alignment at the organisation/change management:** Ensuring that the entire organisation is aligned on the purpose for implementation can be challenging.  
...
* **Challenge - Scalability of the process:** Implementing narrative CVs may be daunting especially in small institutions or in very large programmes.  
