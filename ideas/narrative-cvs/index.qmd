...
categories: ["Level 5", "Aim: Inclusivity", "Aim: Recognition", "Aim: Diversity", "Aim: Alternative questions", "CoARA Commitment 1", "CoARA Commitment 2", "CoARA Commitment 3", "Target: Funder", "Target: Academic institution", "Target: Scholarly association", "Target: Research group", "Target: Meta-researcher"]
...
**Challenge:** Narrative CVs are sometimes criticised for reducing the objectivity of applications processes, especially when compared to numerical metrics.  
...
**Challenge:** Ensuring that the entire organisation is aligned on the purpose for implementation can be challenging.  
...
**Challenge:** Implementing narrative CVs may be daunting especially in small institutions or in very large programmes.  
