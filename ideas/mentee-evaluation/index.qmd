...
**Challenge: ** Monitoring improvement and how effective this is  
...
**Mitigation:** Make the template clear enough to allow to 'read between the lines'. Assessor training can also help with this (i.e., Qualitative evaluation in Pep-CV could be relevant to this, but not open in itself). Se related idea on [qualitative assessment training](/ideas/qualitative-assessor-training/).  
...
Vitae [Reseacher Development Framework - competence framework for researchers](https://vitae.ac.uk/vitae-researcher-development-framework/) and [Competence frameworks for Research Managers](https://research-and-innovation.ec.europa.eu/jobs-research/rm-comp-european-competence-framework-research-managers_en#other-eu-competence-frameworks)

## Templates from funders and institutions 

## Case examples and literature

[FNR Mentee evaluation](https://www.researchluxembourg.org/en/research-landscape/research-culture/mentorship-charter/) provides gender balanced list of former mentees, FNR decides on two, sends them an evaluation template to them.
