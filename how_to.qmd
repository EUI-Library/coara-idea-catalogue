...
![List of tags (example)](/images/Categories_Bar.png){width=40%}
...
*Note that this completeness level refers to how the ideas are developed withint the Catalogue, not to how they are implemented in practice.*
...
[Read the full guide](hypothesis-annotation-guide.qmd)
